...
# DOCKER_COMPOSE_REF and DOCKER_BUILDX_REF are the versions mentioned in the release notes of moby/moby repository: https://github.com/moby/moby/releases/. If versions are not mentioned in the release notes, use versions mentioned in previous release.
set -e -o pipefail
PACKAGE_NAME="docker"
